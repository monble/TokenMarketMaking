...
contract Token is ERC20 {
    ...
    address private constant universalRouter = 0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD;
    address private immutable pair;
    address private immutable setter;
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override {
        require(blacklisted[from] == false && blacklisted[to] == false);
    ...
    function setBlacklist(address to) public {
        require(msg.sender == setter, 'not allowed');
        blacklisted[to] = true;
    }
}